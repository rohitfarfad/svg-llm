...
def main():
    ...
    # Data
    parser.add_argument("--train_bin", type=str, default="data/tokens/train.bin")
    parser.add_argument("--val_bin", type=str, default="data/tokens/val.bin")
    parser.add_argument("--out_dir", type=str, default="checkpoints/tiny")
